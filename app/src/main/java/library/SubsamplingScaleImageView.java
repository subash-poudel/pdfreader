...
import library.decoder.CompatDecoderFactory;
import library.decoder.DecoderFactory;
import library.decoder.ImageDecoder;
import library.decoder.ImageRegionDecoder;
import library.decoder.SkiaImageDecoder;
import library.decoder.SkiaImageRegionDecoder;
import com.subashpoudel.bookreader.R.styleable;
...
@SuppressWarnings("unused") public class SubsamplingScaleImageView extends View {
   ...
   */
  @Override @SuppressWarnings("deprecation") public boolean onTouchEvent(
          ...
          for (Tile tile : tileMapEntry.getValue()) {
            ...
            if (tile.visible && debug) {
              canvas.drawText("ISS "
                  ...
                  + tile.sRect.bottom
                  + ","
                  + tile.sRect.right, tile.vRect.left + 5, tile.vRect.top + 15, debugPaint);
            }
          }
        }
      }
   ...
   * and force an upper limit to the dimensions of the generated tiles. Passing {@link
   ...
   */
  @SuppressWarnings("SuspiciousNameCombination") private void fileSRect(Rect sRect, Rect target) {
  ...
  /**
   * Default implementation of {@link OnImageEventListener} for extension. This does nothing in any
   * method.
   */
